...
[`@aws-sdk/client-bcm-pricing-calculator`](https://www.npmjs.com/package/@aws-sdk/client-bcm-pricing-calculator/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-pricing-calculator@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-24riR9bUxFVBZmT1UdESegeeQ/WsexF7Q8AdvsWuH6vWnYMbeEVdijfxQuFfDlq5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-bcm-pricing-calculator": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-pricing-calculator@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bcm-pricing-calculator@3.808.0/index.min.mjs": "sha384-24riR9bUxFVBZmT1UdESegeeQ/WsexF7Q8AdvsWuH6vWnYMbeEVdijfxQuFfDlq5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-bcm-pricing-calculator/blob/refs/tags/3.808.0/LICENSE
```
